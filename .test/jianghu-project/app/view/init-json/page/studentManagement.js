/* eslint-disable */
const content = {
  pageType: "jh-page", pageId: "studentManagement", table: "student", pageName: "学生管理", template: "jhTemplateV4", version: 'v3',
  resourceList: [
    {
  ...
  headContent: [
    ...
    { 
      ...
      value: [
        ...
        { tag: "v-text-field", model: "serverSearchWhereLike.className", colAttrs: { cols: 12, md: 3 }, attrs: {prefix: '班级'} },
      ], 
      data: {
